...
?>
  <div class="wrapper">
    <div class="main-container">
      <div class="card">
        <h1 class="text-center my-3 section3">ข้อสอบ</h1>
        ...
        ?>
          <?php 
          $id = $row['Ch_Chapter'];
          $sql1="SELECT * FROM question WHERE Ch_ID = $id";
          $query1=mysqli_query($conn,$sql1);
          $num_rows1 = mysqli_num_rows($query1);
        ?>
          <a class="a go_data" id="<?php echo $row['Ch_Chapter']; ?>"
            href="add_examination.php?id=<?php echo $row['Ch_Chapter']; ?>">
            <div class="sub-card">
              <div class="section"><?php echo $row['Ch_Category']; ?></div>
              <div class="number">Question (<?php echo $num_rows1; ?>)</div>
